...
mixin _$User {
  ...
  int get verifiedReports => throw _privateConstructorUsedError;
    ...
    return _then(_value.copyWith(
      ...
      totalReports: null == totalReports
          ...
          : totalReports // ignore: cast_nullable_to_non_nullable
              as int,
      verifiedReports: null == verifiedReports
          ? _value.verifiedReports
          : verifiedReports // ignore: cast_nullable_to_non_nullable
              as int,
...
class _$UserImpl implements _User {
  ...
  @override
  String toString() {
    return 'User(id: $id, email: $email, name: $name, phone: $phone, avatarUrl: $avatarUrl, reliabilityScore: $reliabilityScore, totalReports: $totalReports, verifiedReports: $verifiedReports, isVerified: $isVerified, createdAt: $createdAt)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.verifiedReports, verifiedReports) ||
                other.verifiedReports == verifiedReports) &&
...
abstract class _User implements User {
  const factory _User(
      ...
      final String? phone,
      final String? avatarUrl,
      required final int reliabilityScore,
      required final int totalReports,
      required final int verifiedReports,
